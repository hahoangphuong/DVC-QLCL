      ...
      <div className="overflow-x-auto">
        <table className="w-full text-xs border-collapse" style={{ minWidth: 1280 }}>
            ...
            {rows.map((row, idx) => (
              <Fragment key={row.loai_ho_so}>
                ...
                {expandedRows[row.loai_ho_so] &&
                  renderSubRow(`${row.loai_ho_so}-first`, "Lần đầu", {
                ...
                {expandedRows[row.loai_ho_so] &&
                  renderSubRow(`${row.loai_ho_so}-supplement`, "Lần bổ sung", {
          ...
          <tfoot>
            ...
            {expandedRows.TOTAL &&
              renderSubRow("TOTAL-first", "Lần đầu", {
            ...
            {expandedRows.TOTAL &&
              renderSubRow("TOTAL-supplement", "Lần bổ sung", {
